...
--
-- Host: localhost
-- Generation Time: May 03, 2021 at 01:19 PM
...
--
-- Database: `finding_psychological_instability`
--
CREATE DATABASE IF NOT EXISTS `finding_psychological_instability` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `finding_psychological_instability`;
...
('40wx9q4z5mwu8tesbdrhp6fpol3ff1gz', 'eyJ1c2VyaWQiOjEwfQ:1lOIna:9eBzXYEe0m0dd7wfDjzFNVxF3NoV76PQ8VKYTYp4zzs', '2021-04-05 11:32:42.589248'),
...
('4jcyq7rrz5rlucwrhlerww9cseajpdmt', 'eyJ1c2VyaWQiOjE0fQ:1lOfAi:fNoDHBy_f-MMQZ4jbFBtoMsx1saQK4_BnKHAKBSlM-I', '2021-04-06 11:26:04.240846'),
...
('kb89037jhe050zhu6y963zsbgoaiwkey', 'eyJ1c2VyaWQiOjE2fQ:1ldYOb:LR41TvfcoSZG3ST1f5s6yL-G3owhwCCYFTTnvRmHunY', '2021-05-17 13:13:57.417345'),
...
(14, 'Ashok', 'Ashok.123@gmail.com', 'Ashok', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(15, 'Shoba', 'Shoba123@gmail.com', 'Shoba', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(16, 'Ragu', 'Ragu123@gmail.com', 'Ragu', '9535866270', 'India', 'Karnataka', 'Bangalore');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_finding_psychological_instability_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_finding_psychological_instability_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `country` varchar(30) NOT NULL,
  `state` varchar(30) NOT NULL,
  `self_employeed` varchar(30) NOT NULL,
  `family_history` varchar(30) NOT NULL,
  `treatment` varchar(30) NOT NULL,
  `work_interferes` varchar(30) NOT NULL,
  `No_of_employees` varchar(30) NOT NULL,
  `remote_network` varchar(30) NOT NULL,
  `technical_company` varchar(30) NOT NULL,
  `benefits` varchar(30) NOT NULL,
  `care_options` varchar(30) NOT NULL,
  `welness_program` varchar(30) NOT NULL,
  `seek_help` varchar(30) NOT NULL,
  `anonymity` varchar(30) NOT NULL,
  `leave1` varchar(30) NOT NULL,
  `mental_health_consequence` varchar(30) NOT NULL,
  `physical_health_consequence` varchar(30) NOT NULL,
  `co_workers` varchar(30) NOT NULL,
  `supervisor` varchar(30) NOT NULL,
  `mental_health_interview` varchar(30) NOT NULL,
  `physical_health_interview` varchar(30) NOT NULL,
  `mental_health` varchar(30) NOT NULL,
  `obs_consequence` varchar(30) NOT NULL,
  `Remarks_or_comments` varchar(30000) NOT NULL,
...
--
-- Table structure for table `remote_user_finding_psychology_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_finding_psychology_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `names` varchar(30) NOT NULL,
  `age` varchar(30) NOT NULL,
  `gender` varchar(30) NOT NULL,
  ...
  `dislikes` int(11) NOT NULL,
  `likes` int(11) NOT NULL,
  `psycho_type` varchar(30) NOT NULL,
  PRIMARY KEY (`id`)
...
--
-- Table structure for table `remote_user_psychology_accuracy_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_psychology_accuracy_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
