...
ROOT_URLCONF = 'finding_psychological_instability.urls'
...
WSGI_APPLICATION = 'finding_psychological_instability.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'finding_psychological_instability',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
